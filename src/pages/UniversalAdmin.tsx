...
import { Loader2, Settings, Building2, Plus, Download, CreditCard } from "lucide-react";
import { DashboardHeader } from "@/components/DashboardHeader";
import { downloadQRCodesHTML } from "@/lib/qrService";
import { PlatformRazorpayConfig } from "@/components/PlatformRazorpayConfig";
              ...
              <Card>
                ...
                <CardContent>
                  <div className="space-y-4">
                    {tenants.map(tenant => (
                      <div key={tenant.id} className="flex flex-col sm:flex-row items-start sm:items-center justify-between p-4 border rounded-lg hover:bg-secondary/50 transition-colors gap-3">
