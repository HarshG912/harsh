  ...
  const handleSubmit = async (e: React.FormEvent) => {
    ...
    try {
      ...
      toast({
        ...
        description: `${formData.restaurantName} has been registered with ${PLANS[formData.plan].name}. Download QR codes below.`,
        duration: 10000,
      });
    } catch (error: any) {
            ...
            <form onSubmit={handleSubmit} className="space-y-4">
              ...
              <div className="space-y-2">
                ...
                <Select
                  ...
                  onValueChange={(value: PlanType) => {
                    ...
                    setFormData({ 
                      ...formData, 
                      plan: value,
                      tableCount: selectedPlan.limits.tables || formData.tableCount
                    });
                  }}
                >
                  <SelectTrigger>
                ...
                <p className="text-xs text-muted-foreground">
                  Table count will be auto-populated based on plan limits
                </p>
              </div>
