  ...
  public: {
    Tables: {
      ...
      razorpay_tenant_secrets: {
        ...
        Relationships: [
          {
            foreignKeyName: "razorpay_tenant_secrets_tenant_id_fkey"
            columns: ["tenant_id"]
            isOneToOne: true
            referencedRelation: "public_tenant_info"
            referencedColumns: ["id"]
    ...
    Functions: {
      ...
      get_user_tenant_id_bypass: { Args: never; Returns: string }
      has_role: {
        Args: {
